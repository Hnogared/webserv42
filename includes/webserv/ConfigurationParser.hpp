...
private:
    ...
    static void _openConfigFile(const std::string &path, std::ifstream &file);
...
public:
    ...
    public:
        ...
        explicit ConfigException(const std::string &message, int code = 10);
    ...
    public:
        ...
        /* Operator overloads */
        InvalidConfigFile &operator=(const InvalidConfigFile &original);
    ...
    public:
        ...
        UnexpectedToken(const t_token &token, const std::string &context);
        UnexpectedToken(const t_token &token, const std::string &context,
