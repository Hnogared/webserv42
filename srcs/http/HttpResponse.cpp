...
/*   Updated: 2024/05/23 16:38:54 by hnogared         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int HttpResponse::getStatusCode(void) const { return (this->_statusCode); }
...
std::string HttpResponse::toString(bool withBody) const
{
    ...
    result << this->getProtocol() << " " << this->_statusCode << " "
           << this->getStatusLine() << "\r\n";
                                    ...
                                    const std::string &statusLine)
{
    ...
    body =
        ...
        message +
        "</h1></center>\n"
        "  <hr><center>" WS_SERVER_NAME "/" WS_SERVER_VERSION
        "</center>\n"
        "</body>\n"
        "</html>\n";
